...
#--------------------------------------------------------------------------------------------------#
    ...
    regressorpath = '101_people_counter/regressor_' + args.customer + '.pickle'
    ...
    CNT_DOWN = 0
    #ai_db
    SQL_CONNECTION = 'sqlite:///102_user_display_and_settings_module/db.sqlite3'
    ...
    logger.warning("Testing-Result: up target / up estimation: %s / %s "\
